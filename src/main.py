...
#             await (
#                 session.flush()
#             )  # Flush the session to get the ID of the newly inserted scraper_data_db
...
#                 player_skill_db = PlayerSkillsDB(
#                     scraper_id=scraper_data_db.scraper_id, **player_skill.model_dump()
#                 )
...
#                 player_activity_db = PlayerActivitiesDB(
#                     scraper_id=scraper_data_db.scraper_id,
#                     **player_activity.model_dump(),
#                 )
